...
describe('OrderReadOnlyPort — Unit (puerto)', () => {
    it('validates order existence, ownership and amount before initiating payment', async () => {
        ...
        const uc2 = new InitiatePaymentUsecase(writeRepo, provider, orderReadNull);
        ...
        const uc3 = new InitiatePaymentUsecase(writeRepo, provider, orderReadOther);
        ...
        const uc4 = new InitiatePaymentUsecase(writeRepo, provider, orderReadAmt);
