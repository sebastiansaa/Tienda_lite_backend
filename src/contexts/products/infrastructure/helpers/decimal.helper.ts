 ...
 *   TypeScript type usable here without importar Prisma dentro del dominio.
 ...
 * - Garantía: este `any` no saldrá de la capa `infrastructure`/helpers; el resto
 *   del código usa tipos primitivos (`number`/`string`) exportados por este helper.
 */
