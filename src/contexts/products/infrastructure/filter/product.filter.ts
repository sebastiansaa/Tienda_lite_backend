...
// Tipo local devuelto por el filter — no exponemos tipos de Prisma fuera de infrastructure
 ...
 * Mantiene tipos locales y evita fugas de Prisma fuera de `infrastructure`.
 */
